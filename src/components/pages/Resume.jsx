...
export default function Resume () {
    ...
    <div id="skills-list">
        ...
        <table border="1">
            ...
            <tr><td>React</td><td>SQL</td><td>MERN</td><td>Object-Relational Mapping (ORM)</td><td>MongoDB</td></tr>
            <tr><td>Node.js</td><td>AJAX</td><td>NoSQL</td><td>Progressive Web Applications (PWA)</td><td>Fetch</td></tr>
            <tr><td>Express.js</td><td>State</td><td>jQuery</td><td>Model-View Controller (MVC)</td><td>Day.js</td></tr>
